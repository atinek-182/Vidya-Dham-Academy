...
| **Wave 3 Gate** | Scrollytelling Sitemap Validated | Fluid hierarchy | `checkpoint/wave-3-structure` | `[PENDING]` |
| **Wave 4 Gate** | Mathematical Token Contrast Floor | WCAG 2.2 AA (>= 85) | `checkpoint/wave-4-tokens` | `[PENDING]` |
